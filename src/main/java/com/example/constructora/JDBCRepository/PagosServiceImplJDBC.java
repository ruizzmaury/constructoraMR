...
public class PagosServiceImplJDBC implements PagosServiceJDBC {
    ...
    public List<Pago> getPagos() {
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);
            ...
            while (rs.next()) {
                System.out.println("CONSULTAS JIJI");
                ...
                System.out.println("ID: " + receivedPagos.get(i).getId());
                System.out.println("Trabajador DNI: " + referencedTrabajador.getTrabajador_dni());
                System.out.println("Id OBRA: " + receivedPagos.get(i).getIdObra());
                System.out.println("FechaPago: " + receivedPagos.get(i).getFechaPago());
                System.out.println("Cantidad a pagar : " + receivedPagos.get(i).getCantidad());
                System.out.println("--------------------------------------------------");
                i++;
